...
with open('./prepare_data/Data/ONet/positive.txt', 'r') as f:
    positive = f.readlines()

with open('./prepare_data/Data/ONet/negative.txt', 'r') as f:
    negative = f.readlines()

with open('./prepare_data/Data/ONet/partial.txt', 'r') as f:
    partial = f.readlines()

#with open('./prepare_data/Data/PNet/landmark_12_aug.txt', 'r') as f:
#   landmark = f.readlines()

destination_directory = "./prepare_data/Combined_Data/ONet"

if not os.path.exists(destination_directory):
    os.makedirs(destination_directory)

with open(os.path.join("./prepare_data/Combined_Data/ONet/train_onet_combined.txt"), 'w') as f:
